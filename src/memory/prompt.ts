...
EXAMPLES:
"I prefer coffee" → {"text": "User prefers coffee", "category": "USER_PREFERENCE", "importance": 0.5, "confidence": 1.0}
"My name is Jack" → {"text": "User's name is Jack", "category": "USER_INFO", "importance": 1.0, "confidence": 1.0}
